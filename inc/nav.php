<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="http://localhost/ecomshop/index.php">Home</a>
					</li>
					<li>
						<a href="#">Shop</a>
					...
					<li>
						...
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://localhost/ecomshop/my-account.php">My Orders</a></li>
							<li><a href="http://localhost/ecomshop/edit-address.php">Update Address</a></li>
							<li><a href="http://localhost/ecomshop/logout.php">Logout</a></li>
						</ul>
					</li>
					<li>
						<a href="http://localhost/ecomshop/contact.php">Contact</a>
					</li>
				</ul>
